...
%%
%波面用
T_sum_all_1_46_Lame8 = T_sum_all_1_5+T_sum_all_6_10+T_sum_all_11_15+T_sum_all_16_20+T_sum_all_21_25+T_sum_all_26_30+T_sum_all_31_35+T_sum_all_36_40+T_sum_all_41_46;
%%
%波形用
T_sum_all_1_46_Lame8 = T_sum_all_1_5+T_sum_all_6_10+T_sum_all_11_15+T_sum_all_16_20+T_sum_all_21_25+T_sum_all_26_30+T_sum_all_31_35+T_sum_all_36_40+T_sum_all_41_45+T_sum_all_46;
%%
T_sum_center = T_sum_all_1_46_Lame4(81,81,1,1,:);
T_sum_center = squeeze(T_sum_center);
t2 = 0.03:1/5000:0.1;

%%
T_sum_center_lame8 = T_sum_all_1_46_Lame8(32,32,1,1,:);
T_lame8_center = squeeze(T_sum_center_lame8);
%%
figure;
subplot(2,1,1);
plot(t2, P2);
...
figure;
for t = 1:length(t1)
    surf(xx1, yy1, real(T_sum_all_1_46_Lame8(:,:,:,:,t)));
    xlim([-1.6 1.6]);
    ylim([-1.6 1.6]);
    clim([min(real(T_sum_all_1_46_Lame8(81,81,1,1,:))) max(real(T_sum_all_1_46_Lame8(81,81,1,1,:)))]);
    title(sprintf('Pressure Field\n t=%.4f s', t1(t)));
    view(2);
    shading interp;
    axis square;
...
%%
T_Lame8_squ = squeeze(T_sum_all_1_46_Lame8);